 ...
 */
let favoriteQuote = #"My favorite quote is: "Hogwarts will always be there to welcome you home""#
print(favoriteQuote)
...
let emptyString = ""
if emptyString.isEmpty { print("There's nothing here") } else { print("It's not as empty as I thought") }
/*:
