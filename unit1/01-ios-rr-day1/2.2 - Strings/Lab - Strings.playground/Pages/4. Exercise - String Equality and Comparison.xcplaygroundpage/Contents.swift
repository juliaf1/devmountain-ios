...
if name == nameInCaps { print("The two strings are equal") } else { print("The two strings are not equal") }
/*:
...
if junior.hasSuffix("Jr.") { print("We found a second generation name!") }
