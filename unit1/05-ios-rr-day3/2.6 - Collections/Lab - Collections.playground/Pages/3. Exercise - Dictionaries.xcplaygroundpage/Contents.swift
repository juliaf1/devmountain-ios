 ...
 */
var daysOfMonth = ["January": 31, "February": 28, "March": 31]
print(daysOfMonth)
...
if let daysOfJanuary = daysOfMonth["January"] {
    print("January has \(daysOfJanuary) days")
}
//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let designComponents: [String: [String]] = ["shapesArray": [], "colorsArray": []]
print(designComponents)
...
let lastColorElement = designComponents["colorsArray"]!.last
print(lastColorElement)
/*:
