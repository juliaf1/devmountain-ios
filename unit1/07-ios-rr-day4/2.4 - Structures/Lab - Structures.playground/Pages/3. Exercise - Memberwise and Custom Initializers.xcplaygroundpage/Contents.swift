...
let favoriteBook = Book(title: "Harry Potter", author: "JK Rowling", pages: 573, price: 10.0)
print("My favorite book is \(favoriteBook.title) written by \(favoriteBook.author). It contains \(favoriteBook.pages) pages and it costs \(favoriteBook.price)")
/*:
