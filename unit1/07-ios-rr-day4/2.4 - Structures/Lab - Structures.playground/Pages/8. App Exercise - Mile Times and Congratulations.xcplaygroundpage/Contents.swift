...
let workout = RunningWorkout(distance: 100, time: 200, elevation: 30)
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal { print("Congratulations, you've reached your goal!") }
        }
    }
    var goal: Int
...
var steps = Steps(steps: 199, goal: 200)
steps.takeStep()
/*:
